...
document.addEventListener("DOMContentLoaded", async function(event) {
  ...
  if (window.ethereum) {
    ...
    let nmroMintear = document.querySelector(".numeroMintear")
    ...
    console.log(costoMint)
    
    //costo x # de NFTs//
    var total = costoMint.mul(numero)
    console.log(total)
    ...
    const transferencia = await contract.mintLifeOutGenesis(numero, {
    ...
    btnMenos.addEventListener("click", () => {
      numero --
      nmroMintear.innerHTML = numero
      costoTotal.innerHTML += valEth
    })
